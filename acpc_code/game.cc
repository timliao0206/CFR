...
Game *readGame( FILE *file )
{
  ...
  while( fgets( line, MAX_LINE_LEN, file ) ) {
    ...
    if( !strncmp( line, "END GAMEDEF", 11 ) ) {

      break;
    } else if( !strncmp( line, "GAMEDEF", 7 ) ) {
